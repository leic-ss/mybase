...
int32_t main(int32_t argc, char* argv[])
{
    ...
    const char* log_file = sDefaultConfig.getString(sMetaSection, sLogFile, "logs/meta.log");
    const char* log_level = sDefaultConfig.getString(sMetaSection, sLogLevel, "info");
