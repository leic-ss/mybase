...
#include "kvstore/walstore/walstore.h"
...
class kv_state_mgr: public state_mgr {
public:
    kv_state_mgr(const std::string& base_path, uint32_t part_id, uint64_t srv_id, const std::string& endpoint, ptr<logger> logger_=nullptr)
        : my_id_(srv_id)
        , partid(part_id)
